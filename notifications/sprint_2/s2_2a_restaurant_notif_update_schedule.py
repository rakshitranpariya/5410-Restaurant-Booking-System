...
def lambda_handler(event, context):
    messageToRestaurant = event["messageToRestaurant"]
    restaurantEmail = event["restaurantEmail"]
    reservationId = event["reservationId"]
    minutesToDeduct = event["minutesToDeduct"]


    scheduled_date = event["reservationDate"]
    scheduled_time = event["reservationTime"]
    ...
    response = event_bridge_client.update_schedule(
        Name=reservationId,
        FlexibleTimeWindow={
                'Mode': 'OFF'
            },
